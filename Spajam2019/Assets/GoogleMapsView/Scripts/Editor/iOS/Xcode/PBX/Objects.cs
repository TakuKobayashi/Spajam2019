...
#else
namespace UnityEditor.iOS.Xcode.GoogleMaps.PBX
#endif
{
    class PBXObjectData
    {   
    ...
    class PBXBuildFileData : PBXObjectData
    {
        ...
        static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "fileRef/*"
        });
    ...
    class XCConfigurationListData : PBXObjectData
    {
    ...
    class FileGUIDListBase : PBXObjectData
    {
    ...
    class PBXSourcesBuildPhaseData : FileGUIDListBase
    {
    ...
    class PBXFrameworksBuildPhaseData : FileGUIDListBase
    {
    ...
    class PBXContainerItemProxyData : PBXObjectData
    {
        static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "containerPortal/*"
        });
    ...
    class PBXReferenceProxyData : PBXObjectData
    {
        static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "remoteRef/*"
        });
