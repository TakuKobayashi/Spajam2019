...
#endif
{
    ...
    public class PBXProject
    {
        ...
        string AddFileImpl(string path, string projectPath, PBXSourceTree tree, bool isFolderReference)
        {
        ...
        void RemoveGroupChildrenRecursive(PBXGroupData parent)
        {
        ...
        PBXGroupData GetPBXGroupChildByName(PBXGroupData group, string name)
        {
        ...
        IEnumerable<string> GetAllTargetGuids()
        {
        ...
        string AddBuildConfigForTarget(string targetGuid, string name)
        {
        ...
        void RemoveBuildConfigForTarget(string targetGuid, string name)
        {
