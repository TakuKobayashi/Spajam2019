...
#endif
{
    ...
    public class ProjectCapabilityManager
    {
        ...
        readonly string m_TargetGuid;
        readonly string m_PBXProjectPath;
        readonly string m_EntitlementFilePath;
        PlistDocument m_Entitlements;
        PlistDocument m_InfoPlist;
        ...
        PlistDocument GetOrCreateEntitlementDoc()
        {
            if (m_Entitlements == null)
            {
        ...
        PlistDocument GetOrCreateInfoDoc()
        {
            if (m_InfoPlist == null)
            {
        ...
        PlistElementString GetOrCreateStringElementInArray(PlistElementArray root, string value)
        {
        ...
        PlistElementDict GetOrCreateUniqueDictElementInArray(PlistElementArray root)
        {
            PlistElementDict r;
