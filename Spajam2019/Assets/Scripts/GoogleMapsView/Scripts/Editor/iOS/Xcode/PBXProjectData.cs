...
#else
using UnityEditor.iOS.Xcode.GoogleMaps.PBX;
#endif

#if UNITY_XCODE_API_BUILD
namespace UnityEditor.iOS.Xcode
#else
namespace UnityEditor.iOS.Xcode.GoogleMaps
#endif
{
    using PBX;
    ...
    {
        Dictionary<string, SectionBase> m_Section = null;
        PBXElementDict m_RootElements = null;
        PBXElementDict m_UnknownObjects = null;
        string m_ObjectVersion = null;
        List<string> m_SectionOrder = null;

        Dictionary<string, UnknownSection> m_UnknownSections;
        PBXBuildFileSection buildFiles = null; // use BuildFiles* methods instead of manipulating directly
        PBXFileReferenceSection fileRefs = null; // use FileRefs* methods instead of manipulating directly
        PBXGroupSection groups = null; // use Groups* methods instead of manipulating directly
        ...
        Dictionary<string, Dictionary<string, PBXBuildFileData>> m_FileGuidToBuildFileMap = null;
        Dictionary<string, PBXFileReferenceData> m_ProjectPathToFileRefMap = null;
        Dictionary<string, string> m_FileRefGuidToProjectPathMap = null;
        Dictionary<PBXSourceTree, Dictionary<string, PBXFileReferenceData>> m_RealPathToFileRefMap = null;
        Dictionary<string, PBXGroupData> m_ProjectPathToGroupMap = null;
        Dictionary<string, string> m_GroupGuidToProjectPathMap = null;
        Dictionary<string, PBXGroupData> m_GuidToParentGroupMap = null;
        ...
        void BuildCommentMapForBuildFiles(GUIDToCommentMap comments, List<string> guids, string sectName)
        {
        ...
        static PBXElementDict ParseContent(string content)
        {
