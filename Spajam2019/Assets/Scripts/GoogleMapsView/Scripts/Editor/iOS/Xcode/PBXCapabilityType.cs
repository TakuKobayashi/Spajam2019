...
#endif
{
    ...
    public sealed class PBXCapabilityType
    {
        ...
        readonly bool m_RequiresEntitlements;
        readonly string m_Framework;
        readonly bool m_OptionalFramework;
        ...
        PBXCapabilityType(string _id, bool _requiresEntitlements, string _framework = "", bool _optionalFramework = false)
        {
            m_ID = _id;
