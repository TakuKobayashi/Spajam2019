...
#endif
{
    ...
    class PBXGUID
    {
        ...
        static GuidGenerator guidGenerator = DefaultGuidGenerator;
    ...
    class FileTypeUtils
    {
        ...
        static readonly Dictionary<string, FileTypeDesc> types =
        ...
        static readonly Dictionary<PBXSourceTree, string> sourceTree = new Dictionary<PBXSourceTree, string> 
        {
        ...
        static readonly Dictionary<string, PBXSourceTree> stringToSourceTreeMap = new Dictionary<string, PBXSourceTree> 
        {
